...
- (void)drawRect:(CGRect)rect {
    ...
    UILabel *line =[[UILabel alloc] initWithFrame:CGRectMake(0, 0, rect.size.width, .5)];
    ...
    [copysButton setImage:[UIImage imageNamed:@"Fav_Multi_CopyH0"] forState:UIControlStateNormal];
    ...
    [sharesButton setImage:[UIImage imageNamed:@"Fav_Multi_ForwardH1"] forState:UIControlStateNormal];
    ...
    [deleteButton setImage:[UIImage imageNamed:@"Fav_Multi_DeleteH2"] forState:UIControlStateNormal];
